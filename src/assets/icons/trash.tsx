...
const Trash = (props: React.SVGProps<SVGSVGElement>) => {
    ...
    return (
        ...
        <path fill-rule="evenodd" clip-rule="evenodd" d="M8.0513 2.68377C8.18741 2.27543 8.56955 2 8.99998 2H15C15.4304 2 15.8126 2.27543 15.9487 2.68377L16.7207 5H20V7H4V5H7.27922L8.0513 2.68377ZM14.2792 4L14.6126 5H9.38741L9.72074 4H14.2792Z" fill={color}/>

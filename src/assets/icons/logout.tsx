...
const Logout = (props: React.SVGProps<SVGSVGElement>) => {
    ...
    return (
        ...
        <path fill-rule="evenodd" clip-rule="evenodd" d="M17.7071 7.29289L21.7071 11.2929C22.0976 11.6834 22.0976 12.3166 21.7071 12.7071L17.7071 16.7071L16.2929 15.2929L18.5858 13H7V11H18.5858L16.2929 8.70711L17.7071 7.29289Z" fill={color}/>
